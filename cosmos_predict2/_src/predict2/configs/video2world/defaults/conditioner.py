...
def register_conditioner():
    from cosmos_predict2._src.predict2.sam3d.conditioner import SAM3DVideoPredictionConditioner
    ...
    cs.store(
        group="conditioner",
        package="model.config.conditioner",
        name="sam3d_video_prediction_conditioner",
        node=SAM3DVideoPredictionConditioner,
    )
