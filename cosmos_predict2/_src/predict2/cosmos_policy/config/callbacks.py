...
class WandbCallback(WandBCallbackImage):
    def __init__(
        ...
        self.train_img_unstable_count = torch.zeros(1, device="musa")
        self.train_video_unstable_count = torch.zeros(1, device="musa")
        ...
        self.val_img_unstable_count = torch.zeros(1, device="musa")
        self.val_video_unstable_count = torch.zeros(1, device="musa")
