...
from cosmos_predict2._src.transfer2.auxiliary.depth_anything.model_utils import get_model_cache_path
...
class VideoDepthAnythingModel:
    def __init__(
        ...
        self.device = device or ("musa" if torch.musa.is_available() else "cpu")
        self.model = None
