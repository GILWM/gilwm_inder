...
from cosmos_predict2._src.predict2.networks.minimal_v4_dit import Block as BaseBlock
from cosmos_predict2._src.predict2.networks.minimal_v4_dit import MiniTrainDIT as BaseMiniTrainDIT
